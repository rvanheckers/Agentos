...
class RoadmapConverter:
    ...
    def _extract_metadata(self, content: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_validated": validation_match.group(1) if validation_match else "2024-12-01",
            "version": "1.0.0",
            "language": "nl"
        }
    ...
    def _extract_current_status(self, content: str) -> Dict[str, Any]:
        ...
        for match in db_matches:
            database_items.append({
                "name": match[0].replace('viral_score', 'viral_score_column'),
    ...
    def _extract_phases(self, content: str) -> List[Dict[str, Any]]:
        ...
        phase1_match = re.search(
            r'## 🔴 FASE 1: KRITIEKE FIXES \(Week 1\)(.*?)(?=## 🟡 FASE 2:|$)',
            content,
            re.DOTALL
        )
        ...
        phase2_match = re.search(
            r'## 🟡 FASE 2: UI INTEGRATIE \(Week 2\)(.*?)(?=## 🟢 FASE 3:|$)',
            content,
            re.DOTALL
        )
            ...
            "audio_transcriber_py": {
                ...
                "add_after_line_430": {
                    "functions": [
                        ...
                        {"name": "_cleanup_temp_files", "purpose": "Clean up compressed and chunk files after processing", "implementation": "try/finally block to ensure cleanup"}
                    ]
                },
                "modify_at_line_475": {
    ...
    def _extract_technical_spec_references(self, content: str) -> Dict[str, Any]:
        ...
        # Find all task sections with technical specs
        ...
        for task_id, task_title, spec_file in task_sections:
            references[task_id] = {
                "title": task_title,
                "spec_file": spec_file,
                "absolute_path": f"roadmap/{spec_file}",
