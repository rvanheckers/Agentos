  ...
  constructor() {
    this.config = {
      ...
      allowedUrlPatterns: [
        ...
        /^https?:\/\/(www\.)?vimeo\.com\/.+/,
        /^https?:\/\/(www\.)?twitch\.tv\/.+/,
        /^https?:\/\/(www\.)?(tiktok\.com|vm\.tiktok\.com)\/.+/,  // TikTok support
        /^https?:\/\/(www\.)?instagram\.com\/(p|reel|reels)\/.+/, // Instagram Reels
        /^https?:\/\/(www\.)?twitter\.com\/.+\/status\/.+/,       // Twitter/X videos
        /^https?:\/\/(www\.)?x\.com\/.+\/status\/.+/,             // X.com videos
