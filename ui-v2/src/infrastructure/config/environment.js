...
export const Environment = {
  // API Configuration - AgentOS Port Range: 8100-8199
  API: {
    BASE_URL: 'http://localhost:8101',
    MCP_BASE_URL: 'http://localhost:8101/api/mcp',
    LEGACY_BASE_URL: 'http://localhost:8101/api',
    WEBSOCKET_URL: 'ws://localhost:8165',
    MEDIA_BASE_URL: 'http://localhost:8101',
