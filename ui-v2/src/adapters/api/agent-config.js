...
class AgentConfigService {
  ...
  initializeDefaultMappings() {
    ...
    // 1. VISUAL CLIPS - Audio + Moments + Face-aware processing
    this.intentWorkflows.set('visual_clips', [
      'audio_transcriber',      // Extract audio + timestamps
      'moment_detector',        // Find viral moments
      'face_detector',          // Detect faces for smart cropping
      'intelligent_cropper',    // Smart 9:16 cropping
    ...
    // 3. SMART CONTENT - AI-enhanced content creation with face-aware cropping
