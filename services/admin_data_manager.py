...
# from events.workflow_orchestrator import get_workflow_orchestrator  # DISABLED - not available
...
class AdminDataManager:
    ...
    #     return get_workflow_orchestrator()  # DISABLED - not available
    ...
    def _get_jobs_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # V4: Add active workflows from orchestrator - DISABLED
            # active_workflows = self.workflow_orchestrator.get_active_workflows()
            active_workflows = []  # Fallback empty list
    ...
    def _get_system_health(self) -> Dict[str, Any]:
        ...
        try:
            # V4: Include orchestrator and event system status - DISABLED
            # active_workflows = self.workflow_orchestrator.get_active_workflows()
            active_workflows = []  # Fallback
            ...
            return {
                ...
                # "workflow_orchestrator_status": "healthy",  # DISABLED
