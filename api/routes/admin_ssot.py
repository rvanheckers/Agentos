...
async def get_admin_ssot_data(
    ...
    try:
        ...
        # SIMPLIFIED: Use AdminDataManager.get_all_data() async method
        logger.info(f"Fetching admin SSOT data via get_all_data()")
        ...
        if filters:
            response_data["logs"] = {"logs": [], "total": 0, "filters": filters}
...
# DISABLED: Sub-endpoints not used by frontend - everything goes through main /api/admin/ssot
...
# DISABLED: Health sub-endpoint not used by frontend - main health at /health
