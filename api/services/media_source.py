    ...
    def validate(self) -> Tuple[bool, Optional[str]]:
        ...
        if ext not in valid_extensions:
            if ext:
                ...
                return False, "❌ Geen geldig bestandstype gevonden. Upload een video bestand (MP4, AVI, MOV, etc.)"
        ...
        try:
            ...
            if result.returncode != 0 or 'video' not in result.stdout:
                return False, "❌ Bestand lijkt beschadigd of is geen geldige video. Probeer een ander bestand."
