...
from routes import websocket  # Keep WebSocket + system (for Quick Actions)

logger = get_logger("api_server")

# Import refactored routes with service layer
try:
    from routes import job_refactored, queue_refactored, upload_refactored, agents_refactored, clips_refactored, admin_actions, admin_ssot
